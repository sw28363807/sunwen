(function () {
    ...
    class Cat extends Spine {
        ...
        initMaskAnim() {
            ...
            this.maskAnim.load("anim/UIdonghua.sk", Laya.Handler.create(this, function() {
                ...
                this.maskAnimLoaded = true;
                if(this.maskAnim.visible) {
    ...
    class SyncDataMgr {
        ...
        addScene2Food(time, quality) {
            if(!this._scene2ExhaustTime || this._scene2ExhaustTime < TimeUtils.getTimeNowOnServer()) {
                this._scene2ExhaustTime = TimeUtils.getTimeNowOnServer()+time;
    ...
    class CoffeeCatTLInterpreter extends TLInterpreter{
        ...
        IntoBuilding(action, args, mode) {
            if(mode==1){
                ...
                owner.showMaskAnim(Laya.Handler.create(this, function() {
    ...
    class CoffeeCatRole {
        ...
        _intoBuilding(info) {
            if(info && info[0] && info[1]) {
                ...
                if(type==1){
                    ...
                    this._context.recordEvent(this.getId(), "IntoBuilding", {"type":type, "time": 10900, "buildingId":buildingId, "spaceId":spaceId});
                }else if(type==2){
                    //休息
                    this._state = "rest";
        ...
        _outBuilding(info) {//假如猫没了？
            ...
            this._context.recordEvent(this.getId(), "OutBuilding", {"time": 500, "buildingId":buildingId, "spaceId":spaceId});
    ...
    class CoffeeSceneLogic extends Logic {
        ...
        _showCat() {
            if (this._roleMgr.getStackRoleCount() > 0) {
                let spaceCount = BuildingSystem.getTotalSpaceCountInScene(Constants.CoffeeSceneId);            if(this._roleMgr.getRoleListCount() < spaceCount + 6) {
    ...
    class BeachCatRole {
        ...
        start(context, currentTime) {
            ...
            buildingData.occupy(this.spaceId, this.catData.getCatId());
            this._context = context;
            this._state = "inBuilding";

            this._context.recordMetaEvent(this.getId(), "AddCat", {"catId":this.catData.getCatId(), "buildingId":this.buildingId, "spaceId":this.spaceId}, "BeachCatLine");
        ...
        remove() {
            ...
            if(this._state!="leaving"){
                let buildingData = BuildingSystem.getBuildingDataByBid(this.buildingId);
                buildingData.leave(this.spaceId, this.catData.getCatId());
                this._context.recordEvent(this.getId(), "RemoveCat", null);
                return true;
            }
            return false;
            ...
            if(arr) {
                for(const buildingData of arr) {
                    ...
                    if(buildingData.attractCD<=0) {
                        let catWeightedSum = buildingData.getCatWeightedSum();
                        let catVisitWeightedArray = buildingData.getCatWeightedArray();
                        let d = Utils.randomExt(catWeightedSum);
    ...
    class BeachSession {
        ...
        prepare() {
            ...
            // EventMgr.getInstance().registEvent("FORCE_ATTRACT_BEACH_CAT", this, this.onForceAttractCat);
        }
        ...
        destroy() {
            Laya.timer.clearAll(this);
            // EventMgr.getInstance().removeEvent("FORCE_ATTRACT_BEACH_CAT", this, this.onForceAttractCat);
        }
    }
    ...
    class ProtoIds {
        ...
        static getRequestMap() {
            ...
            protoIDs["Scene.GetFishGameInfoReq"] = [10206, Scene.GetFishGameInfoReq];
            protoIDs["Scene.PlayFishGameReq"]  = [10207, Scene.PlayFishGameReq];
        ...
        static getResponseMap() {
            ...
            protoIDs[10206] = ["Scene.GetFishGameInfoRes", Scene.GetFishGameInfoRes];
            protoIDs[10207] = ["Scene.PlayFishGameRes", Scene.PlayFishGameRes];
